...
parser.add_argument('--trained_model', default='weights/VOC_1800.pth',
...
parser.add_argument('--SIXray_root', default=SIXray_ROOT, help='Location of VOC root directory')
...
def test(img_path):
    ...
    testset = SIXrayDetection(args.SIXray_root, img_path, None, SIXrayAnnotationTransform())
    if args.cuda:
        net = net.cuda()
