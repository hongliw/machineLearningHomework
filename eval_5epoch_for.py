...
parser.add_argument('--imagesetfile',
                    ...
                    default="media/trs2/Xray20190723/train_test_txt/battery_sub/sub_eval_core_coreless.txt", type=str,
...
"""
    ...
    #{'core_battery00000743': [{'name': '带电芯充电宝', 'pose': 'Unspecified', 'truncated': 0, 'difficult': 0, 'bbox': [551.0, 810.0, 735.0, 880.0]}], 'core_battery00000744': [{'name': '带电芯充电宝', 'pose': 'Unspecified', 'truncated': 0, 'difficult': 0, 'bbox': [1753.0, 514.0, 1832.0, 644.0]}], 'coreless_battery00002253': [{'name': '不带电芯充电宝', 'pose': 'Unspecified', 'truncated': 0, 'difficult': 0, 'bbox': [408.0, 632.0, 550.0, 800.0]}], 'coreless_battery00002258': [{'name': '不带电芯充电宝', 'pose': 'Unspecified', 'truncated': 0, 'difficult': 0, 'bbox': [960.0, 579.0, 1162.0, 688.0]}]}
    # print (recs)
    # print (classname)
...
def test_net(save_folder, net, cuda, dataset, transform, top_k,
    ...
    output_dir = get_output_dir('ssd300_12000', set_type)
...
def reset_args(EPOCH):
    global args
    # args.trained_model = "/media/trs2/SSD/weights/Xray20190723/2019-10-18_16-23-15Xray0723_bat_core_coreless_bs8_V_resume140/ssd300_Xray20190723_{:d}.pth".format(
       
    args.trained_model = "/Users/yeungharvey/Documents/learn/machineLearningHomework/weights/VOC_1800.pth"
    # saver_root = '/media/trs2/wuzhangjie/SSD/eval/Xray20190723/Attention/base_battery_core_coreless_bs8_V/'
    saver_root = '/Users/yeungharvey/Documents/learn/machineLearningHomework/evaldata/'
